...
public class StickOfHappiness : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    public void OnDrag(PointerEventData ped)
    {
        ...
        handle.rectTransform.anchoredPosition = new Vector3(inputVector.x * (background.rectTransform.sizeDelta.x / handleRange)
                                             , inputVector.z * (background.rectTransform.sizeDelta.y / handleRange)); // <- Wait, but why the because?
